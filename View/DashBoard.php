        ...
        <div class="DashboardCards">
          ...
          <div class="card">
            <div class="cardLogo_Percent">
              <span id="Tickets_icon_Bg" class="card_icon_BG"
                ><i class="ri-ticket-line"></i
              ></span>
              <span class="Dashboard_cards_Percent" id="soldTicketPercent"
                >+12.5%
              </span>
            </div>
            <h3>1,250</h3>
          ...
          <div class="card">
            <div class="cardLogo_Percent">
              <span id="Active_Event_BG" class="card_icon_BG"
                ><i class="ri-calendar-event-line"></i
              ></span>
              <span id="Active_event_percent" class="Dashboard_cards_Percent"
                >+12.5%
              </span>
            </div>
            <h3>150</h3>
          ...
          <div class="card">
            <div class="cardLogo_Percent">
              <span id="Revenue_icon_BG" class="card_icon_BG"
                ><i class="ri-money-dollar-circle-line"></i
              ></span>
              <span id="Revenue_percent" class="Dashboard_cards_Percent"
                >+12.5%
              </span>
            </div>
            <h3>$58,965</h3>
          ...
          <div class="card">
            <div class="cardLogo_Percent">
              <span id="Total_User_icon_BG" class="card_icon_BG"
                ><i class="ri-user-line"></i
              ></span>
              <span id="Total_user_percent" class="Dashboard_cards_Percent"
                >+12.5%
              </span>
            </div>
            <h3>15,500</h3>
          ...
          <div id="RevenueStatsContainer" class="RevenueStats_SalesTrendsCards">
            <div id="RevenueStatsContainer_header">
              ...
              <span id="RevenueStatsContainer_header_links_Container">
                <span class="RevenueStatsContainer_header_links"
                  ><a href="#">Week</a></span
                >
                <span class="RevenueStatsContainer_header_links"
                  ><a href="#">Year</a></span
